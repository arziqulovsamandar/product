            ...
            >
                  ...
                  <div class="flex flex-wrap p-[10px] gap-[10px]">
                    ...
                    >
                      <div class="flex items-center">
                        <i
                          class="bx bx-ghost text-main-100 text-[25px] mr-1"
                        ></i>
                        <div
                    ...
                    >
                      <div class="flex items-center">
                        <i
                          class="bx bxs-pyramid text-main-100 text-[25px] mr-1"
                        ></i>
                        <div>
                    ...
                    >
                      <div class="flex items-center">
                        <i
                          class="bx bxs-institution text-main-100 text-[25px] mr-1"
                        ></i>
                        <div>
              ...
              >
                <i
                  class="xl:pl-[17px] pl-[8px] bx bxs-hot text-[25px] mr-[2px]"
                ></i>
                <span class="text-[16px] pr-[17px] font-semibold"
                  >Hot Deals</span
                >
              </a>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-col justify-center items-center w-[120px]">
                ...
                <span class="text-[12px] tracking-wide">{{
                  t("navbar_dropdown.support.support")
                }}</span>
                <a
                  href="/"
                  class="text-[22px] leading-[0.8] font-semibold"
