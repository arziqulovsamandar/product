  ...
  >
    <div class="h-full mt-4">
      ...
      <div class="w-full h-full">
        <img
          class=" w-full h-full object-cover rounded-[30px] hover:p-0 transition-all duration-300"
    ...
    <div class="mt-4">
      <div v-if="product?.category?.name">
        <p class="text-[14px] text-fortitle-100 mb-2">{{ product?.category?.name }}</p>
      </div>
      <div>
      ...
      <div class="flex text-main-100 font-bold gap-3 justify-between items-baseline mb-2">
        <s class="text-gray-400">$<s class="text-[13px] text-primary">{{ product.price }}</s></s>
