<template>
  <div class="main w-[280px] relative p-5 justify-around border-2 border-slate-200 hover:shadow-lg shadow-slate-800 duration-500 ease-in-out cursor-pointer rounded-2xl h-auto m-2">
    <div class="bg-blue-300 text-white w-[22%] h-[6%] absolute top-0 left-0 text-center rounded-br-2xl rounded-tl-xl">
      13%
    </div>
    <div class="bg-primary text-white w-[22%] h-[6%] absolute top-0 right-0 text-center rounded-bl-2xl rounded-tr-xl">
      Sale
    </div>
    <div>
    ...
    <div class='mb-3'>
      <p style='color: gray'>By <a href="http://localhost:3000/" style="color: #46d573; font-size: larger; opacity: 100%">NestFood</a></p>
    </div>
    <div class="flex text-primary font-bold gap-3 items-baseline mb-2">
      ...
      <button @click="addToCart" class="bg-primary text-white px-4 py-2 rounded-md flex items-center ml-8 opacity-100 hover:opacity-100">
